    ...
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            try
            {
                ...
                builder.Services.AddScoped<Bags_Shop_API.Services.PaymentServices.Commands.CreatePaymentCommandHandler>();

                builder.Services.AddScoped<IOrderServices, OrderServices>();
                builder.Services.AddScoped<IPaymentServices, PaymentServices>();
                builder.Services.AddScoped<IPayMobServices, PaymobServicev2>();
                builder.Services.AddScoped<IPaymentProcessor, PaymobServicev2>();
                ...
                builder.Services.AddCors(options =>
                {
                    ...
                    {
                        policy.AllowCredentials().WithOrigins("https://ziko-store.vercel.app", "http://localhost:5173", "https://admin-ziko-store.vercel.app").AllowAnyHeader().AllowAnyMethod();
                    });
                });
                ...
                builder.Services.AddHangfire(config =>
                    config.UseStorage(
                        new SqlServerStorage(
                            builder.Configuration.GetConnectionString("Monster"),
                ...
                // builder.Logging.AddConsole(); // Removed in favor of Serilog
                ...
                app.UseMiddleware<UserKeyMiddleware>();
